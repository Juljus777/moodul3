<div id="carouselDesktop" class="carousel slide main-banner" data-ride="carousel">
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
            <img src="{{ asset('images/banners/WITCHER BANNER 2.jpg') }}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="{{ asset('images/banners/WITCHER BANNER 3.jpg') }}" class="d-block w-100" alt="...">
        </div>
    </div>
...
<div id="carouselMobile" class="carousel slide main-banner" data-ride="carousel">
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
            <img src="{{ asset('images/banners/WITCHER BANNER 2 MOBILE.jpg') }}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="{{ asset('images/banners/WITCHER BANNER 3 MOBILE.jpg') }}" class="d-block w-100" alt="...">
        </div>
    </div>
